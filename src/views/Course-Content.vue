<template>
    ...
    <el-card class="course-content">
        <el-tabs>
            ...
            <el-tab-pane label="刷题" lazy>
                <CourseQuiz/>
            </el-tab-pane>
            <el-tab-pane label="模拟考试" lazy>
                <CourseMockExam :course-id="courseId"/>
            </el-tab-pane>
        </el-tabs>
    </el-card>
...
import CourseQuiz from '../components/Course-Quiz.vue'
import CourseMockExam from '../components/Course-MockExam.vue'
